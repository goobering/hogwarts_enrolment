...
class Admissions
  ...
  student_1 = Student.new({first_name: 'Harry', last_name: 'Potter', house: 'Gryffindor', age: 10})
  student_2 = Student.new({first_name: 'Luna', last_name: 'Lovegood', house: 'Ravenclaw', age: 11})
  student_3 = Student.new({first_name: 'Hermione', last_name: 'Granger', house: 'Gryffindor', age: 9})
  student_4 = Student.new({first_name: 'Draco', last_name: 'Malfoy', house: 'Slytherin', age: 12})
  student_5 = Student.new({first_name: 'Cedric', last_name: 'Diggory', house: 'Hufflepuff', age: 10})
